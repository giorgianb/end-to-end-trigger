...
for batch, mask in tqdm(val_data):
    ...
    if i %  100 == 0:
        ...
        with open('real_inference_results.pkl', 'wb') as f:
            pickle.dump(save, f)
