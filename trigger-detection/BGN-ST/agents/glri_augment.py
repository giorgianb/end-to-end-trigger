...
import main_scripts.main_glri_augment as glri
sweep_id ="xyh79auz"
...
def train():
    print(f'GPU: {GPU}')
    wandb.init(tags=["biatt", "glri", "loopy", "layernorm", "batchnorm", "prelu", "6-layer", "128-dim", "augment"])
    config = {}
    ...
    config['model']['layers_spec'] = [[128, 8], [128, 8], [128, 8], [128, 8], [128, 8], [128, 8]]
    config['wandb'] = {}
    config['wandb']['project_name'] = 'physics-trigger'
    config['wandb']['run_name'] = 'biatt-glri'
    config['wandb']['tags'] = ["biatt", "glri", "loopy", "layernorm", "prelu", "6-layer", "128-dim", "augment"]
    ...
    glri.execute_training(args, config)
