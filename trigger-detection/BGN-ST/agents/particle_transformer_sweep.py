...
import main_scripts.main_particle_transformer as main
sweep_id ="17xkampo"
...
def train():
    ...
    config['model']['layers_spec'] = [[128, 24], [128, 24], [128, 24], [128, 24], [128, 24], [128, 24]]
    config['wandb'] = {}
    config['wandb']['project_name'] = 'physics-trigger'
    config['wandb']['run_name'] = 'biatt-interaction'
    config['wandb']['tags'] = ["biatt", "loopy", "layernorm", "prelu", "6-layer"]
