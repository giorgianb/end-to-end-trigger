...
import main_scripts.main_augment_contrast as main
sweep_id ="eemlj2b0"
...
def train():
    ...
    config['model']['layers_spec'] = [[128, 16], [128, 16], [128, 16], [128, 16], [128, 16]]
    config['wandb'] = {}
    config['wandb']['project_name'] = 'physics-trigger'
    config['wandb']['run_name'] = 'biatt-combined'
