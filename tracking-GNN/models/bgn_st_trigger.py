...
class GNNGraphClassifier(nn.Module):
    ...
    """
    def __init__(self, intt_input_dim=3, mvtx_input_dim=3, hidden_dim=8, n_graph_iters=3, n_layers=3, hidden_activation='ReLU', layer_norm=True, phi_slope_max=None, z0_max=None, apply_constraints=False):
        super().__init__()
        self.apply_constraints = apply_constraints
        self.phi_slope_max = phi_slope_max
        self.z0_max = z0_max
