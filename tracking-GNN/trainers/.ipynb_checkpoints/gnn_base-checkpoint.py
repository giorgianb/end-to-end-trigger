...
class GNNBaseTrainer(object):
    ...
    def __init__(self, output_dir=None, gpu=None,
                 distributed_mode=None, rank=0, n_ranks=1, use_wandb=False):
        ...
        self.best_validation_f1_score = 0
    ...
    def _build_optimizer(self, parameters, name='Adam', learning_rate=0.001,
        ...
        betas = optimizer_args['beta_1'], optimizer_args['beta_2']
        del optimizer_args['beta_1'], optimizer_args['beta_2']
        warmup_factor = 1
    ...
    def train(self, train_data_loader, valid_data_loader=None,
        ...
        for epoch in range(start_epoch, end_epoch):
            ...
            if valid_data_loader is not None:
                ...
                if summary['valid_label_acc'] < 0.6:
                    break
