...
class SparseGNNTrainer(GNNBaseTrainer):
    ...
    def __init__(self, contrastive_loss_func, contrastive_loss_weight, **kwargs):
        super().__init__(**kwargs)
        self.contrastive_loss_func = getattr(torch.nn, contrastive_loss_func)()
        self.contastive_loss_weight = contrastive_loss_weight
    ...
    def train_epoch(self, data_loader):
        ...
        for i, batch in enumerate(tqdm.tqdm(data_loader)):
            ...
            negatives = data_loader.dataset.get_negatives(batch)
            positives = data_loader.dataset.get_positives(batch)
            ...
            contrastive_loss = self.contrastive_loss_func(current_embeddings, positive_embeddings, negative_embeddings)
